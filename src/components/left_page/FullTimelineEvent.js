...
export default function FullTimelineEvent(props) {
    return (
        <div className="timeline-event">
            <div className="deco-bar deco-bar-top"></div>
            <div className="timeline-content w-100 d-flex flex-lg-row flex-column">
                ...
                <div className="info-container mx-auto col-lg-8 col-sm-8">
                    <a href={props.url}>
            ...
            <div className="deco-bar deco-bar-bottom"></div>
        </div>
    );
}