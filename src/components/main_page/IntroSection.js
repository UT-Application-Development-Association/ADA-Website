...
import logo from "../../assets/img/2017_white-logo.png";

export default function IntroSection(props) {
    return (
        <div className="intro-container container">
            <Heading text="基本介绍" white="true" />
            <div className="d-flex flex-column flex-md-row">
                <div className="intro-text paragraph my-3 my-md-4 mx-auto mr-md-4">
                ...
                <div className="logo-container w-100 p-auto">
